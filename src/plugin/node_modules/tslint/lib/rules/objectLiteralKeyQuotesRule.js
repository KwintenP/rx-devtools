...
var ObjectLiteralKeyQuotesWalker = (function (_super) {
    ...
    ObjectLiteralKeyQuotesWalker.prototype.allMustHaveQuotes = function (properties) {
        for (var _i = 0, properties_1 = properties; _i < properties_1.length; _i++) {
            ...
            if (name_1 !== undefined && name_1.kind !== ts.SyntaxKind.StringLiteral && name_1.kind !== ts.SyntaxKind.ComputedPropertyName) {
                var fix = this.createFix(this.appendText(name_1.getStart(), '"'), this.appendText(name_1.getEnd(), '"'));
                this.addFailureAtNode(name_1, Rule.UNQUOTED_PROPERTY(name_1.getText()), fix);
            }
        }
    };
    ObjectLiteralKeyQuotesWalker.prototype.noneMayHaveQuotes = function (properties, noneNeedQuotes) {
        for (var _i = 0, properties_2 = properties; _i < properties_2.length; _i++) {
            ...
            if (name_2 !== undefined && name_2.kind === ts.SyntaxKind.StringLiteral && (noneNeedQuotes || !propertyNeedsQuotes(name_2.text))) {
                var fix = this.createFix(this.deleteText(name_2.getStart(), 1), this.deleteText(name_2.getEnd() - 1, 1));
                this.addFailureAtNode(name_2, Rule.UNNEEDED_QUOTES(name_2.text), fix);
            }
        }
    };
...
function quotesAreInconsistent(properties) {
    ...
    for (var _i = 0, properties_3 = properties; _i < properties_3.length; _i++) {
        var name_3 = properties_3[_i].name;
        if (name_3 === undefined || name_3.kind === ts.SyntaxKind.ComputedPropertyName) {
            continue;
        }
        var thisOneIsQuoted = name_3.kind === ts.SyntaxKind.StringLiteral;
