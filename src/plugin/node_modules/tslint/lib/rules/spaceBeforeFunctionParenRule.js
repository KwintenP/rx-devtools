...
var FunctionWalker = (function (_super) {
    ...
    FunctionWalker.prototype.createInvalidWhitespaceFailure = function (pos) {
        var fix = this.createFix(this.deleteText(pos, 1));
        return this.createFailure(pos, 1, Rule.INVALID_WHITESPACE_ERROR, fix);
    };
    FunctionWalker.prototype.createMissingWhitespaceFailure = function (pos) {
        var fix = this.createFix(this.appendText(pos, " "));
